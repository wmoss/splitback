...
class PieChart extends WebComponent {
  ...
  void updatePieChart() {
    js.scoped(() {
      ...
      //List<Recipient> valid = bill.validRecipients().toList();
      List<Object> valid = bill.validRecipients().toList();
  ...
  void adjustPieChart(int index, int dx) {
    //List<Recipient> recipients = bill.validRecipients().toList();
    //Recipient active = bill.recipients[index];
    List<Object> recipients = bill.validRecipients().toList();
    Object active = bill.recipients[index];
    ...
    List<Object> movable = recipients.where((r) => !r.adjusted).toList();
